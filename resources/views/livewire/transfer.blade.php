        ...
        <div class="p-6 flex flex-col gap-4">
            ...
            <div class="flex flex-col gap-2">
                ...
                <div class="flex">
                    ...
                    <input
                        wire:model.live.debounce.1000ms="recipient"
                        id="username"
                        type="text"
                        class="form-input ltr:rounded-l-none rtl:rounded-r-none"
                    />
            ...
            @if($recipientModel)
                <button wire:click="transfer" class="btn bg-primary text-white mt-2 flex gap-1 items-center" wire:loading.class="opacity-50" wire:loading.attr="disabled">
                    Proceed
