<form wire:submit="transfer" class="flex justify-center w-full">
    <div class="card max-w-lg w-full animate__animated animate__fadeIn">
        <div class="p-6 flex flex-col gap-4">
            ...
            @php
                 if ($currency == \App\Enums\Currency::USD) $flag = 'images/flags/us.jpg';
                 else $flag = 'images/flags/awg.png';
            @endphp
            ...
            <div class="flex flex-col gap-2">
                ...
                <div class="flex">
                    ...
                    >
                        <img src="{{ asset($flag) }}?v1" class="h-4 w-4 rounded-full"  alt="us icon"/>
                    </div>
                    <input
                        wire:model="amount"
                        id="amount"
            ...
            <button type="button" wire:click="findUser" class="w-fit btn bg-primary text-white mt-2 flex gap-1 items-center" wire:loading.class="opacity-50" wire:loading.attr="disabled">
                Check Username
