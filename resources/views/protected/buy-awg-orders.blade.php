                        ...
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col"
                                        class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Merchant
                                    </th>
                                    <th scope="col"
                                ...
                                @foreach ($transactions as $transaction)
                                    <tr>
                                        <td
                                            ...
                                            <a href="{{ route('transaction.buy-awg.show', ['order' => $transaction]) }}"><span class="uppercase underline">{{ $transaction->reference }}</span></a>
                                            @php
