...
@section('content')
    <div class="flex flex-col items-center py-10">
        <div class="mb-6 text-center">
            <h1 class="text-gray-900 text-xl">Conversions History</h1>
        </div>
                        ...
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Received</th>
                            ...
                            @foreach($transactions as $transaction)
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 dark:text-gray-200">
                                        ...
                                        @php
                                            $timeLeft = $transaction->conversion->getTimeLeft()
                                        @endphp
                                        @if($timeLeft > 0)
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">{{ $transaction->conversion->to_currency->toString() }} {{ \Illuminate\Support\Number::format($transaction->conversion->received_amount/100) }}</td>
