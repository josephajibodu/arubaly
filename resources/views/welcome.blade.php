        ...
        <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
            ...
            <div class="text-center">
                ...
                <p class="mt-6 text-lg leading-8 text-gray-600">
                    Looking to make seamless transactions between Aruba Florin (AWG), USD, and Naira? Look no further! Arubaly.com offers a unique triangular exchange platform that empowers you to buy Aruba Florin, convert it to USD, and further exchange it to Naira—all with the potential for substantial profits.
                </p>
